...
export function update() {
    // Set Referances
    const players = Neutron.getGame().getSpritesByType(Player);
    const enemies = Neutron.getGame().getSpritesByType(Enemy);
...
export function init() {
    ...
    const player = Neutron.getGame().getSpritesByType(Player)[0];
